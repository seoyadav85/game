...
class UserController {
    /**
           ...
           */
    static coinUpdate(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                isUserExist.save();
                yield GameRecord_1.default.create({
                    name: type, coin: coin
                });
                return ResponseHelper_1.default.ok(res, "SUCCESS", "Coin Updated Successfully", isUserExist, startTime);
            }
            catch (err) {
                next(err);
            }
